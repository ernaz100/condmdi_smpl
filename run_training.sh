...
#SBATCH -J condmdi_smpl                # Job name
...
#SBATCH --output=/mnt/lustre/work/ponsmoll/pba794/condmdi_smpl/logs/myjob-%j.out       # File to which STDOUT will be written - make sure this is not on $HOME
#SBATCH --error=/mnt/lustre/work/ponsmoll/pba794/condmdi_smpl/logs/myjob-%j.err        # File to which STDERR will be written - make sure this is not on $HOME
